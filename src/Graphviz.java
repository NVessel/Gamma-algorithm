...
public class Graphviz {
     ...
     */
    private final static String cfgProp = "C:\\Users\\User\\config.properties";
     ...
     */
    private static String TEMP_DIR = "C:\\Users\\User";
    ...
    private byte[] get_img_stream(File dot, String type)
    {
        ...
        try {
            ...
            String[] args = {Graphviz.DOT, "-T"+type, "-Gdpi="+dpiSizes[this.currentDpiPos], dot.getAbsolutePath(), "-o", img.getAbsolutePath()};
